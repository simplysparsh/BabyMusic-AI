...
import { Wand2, Play, Download, Share2, Loader2, Clock, Sparkles } from 'lucide-react';
      ...
      <div className="space-y-6">
              ...
              <button
                ...
                className={`min-h-[40px] px-4 py-2.5 sm:px-5 sm:py-3 rounded-full text-sm sm:text-base font-medium transition-all duration-300 ${
                  mood === m
                    ...
                    : 'bg-gradient-to-r from-[#2C3E50]/60 via-[#2C3E50]/40 to-[#1B4F3C]/30 text-white hover:from-[#2C3E50]/70 hover:via-[#2C3E50]/50 hover:to-[#1B4F3C]/40 hover:text-white backdrop-blur-sm border-2 border-gray-400/30'
                }`}
              >
        ...
        <div className="flex justify-center pt-4">
          <button
            ...
            className="flex items-center space-x-3 min-h-[48px] bg-gradient-to-r from-primary via-primary to-secondary
                     text-[#222222] px-8 py-4 rounded-xl hover:opacity-90 transition-all duration-300
        ...
        {isGenerating && (
          <div className="mt-8 space-y-6 fade-in">
            ...
            <div className="p-6 bg-gradient-to-r from-primary/5 via-secondary/5 to-accent/5 
